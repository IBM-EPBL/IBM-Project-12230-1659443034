...
def updateProduct(name):
    ...
    if request.method == "POST":
        ...
        sg = sendgrid.SendGridAPIClient(api_key = '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')
        from_email = Email("arunpradeepvn@gmail.com")
        to_email = To("arunpradeepvn@gmail.com")
        subject = "Sending with SendGrid"
        content = Content("text/plain", "Product Updated Successfully")
